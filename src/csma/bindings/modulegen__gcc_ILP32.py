...
def register_Ns3CsmaChannel_methods(root_module, cls):
    ...
    cls.add_method('GetNumActDevices', 
                   'uint32_t', 
                   [])
    ## csma-channel.h (module 'csma'): size_t ns3::CsmaChannel::GetNDevices() const [member function]
    cls.add_method('GetNDevices', 
                   'size_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## csma-channel.h (module 'csma'): ns3::Ptr<ns3::NetDevice> ns3::CsmaChannel::GetDevice(size_t i) const [member function]
    cls.add_method('GetDevice', 
                   'ns3::Ptr< ns3::NetDevice >', 
                   [param('size_t', 'i')], 
                   is_const=True, is_virtual=True)
    ## csma-channel.h (module 'csma'): ns3::Ptr<ns3::CsmaNetDevice> ns3::CsmaChannel::GetCsmaDevice(size_t i) const [member function]
