...
def register_Ns3CallbackImplBase_methods(root_module, cls):
    ...
    cls.add_method('GetCppTypeid', 
                   'std::string', 
                   [], 
                   is_static=True, template_parameters=['std::__1::basic_string<char', ' std::__1::char_traits<char>', ' std::__1::allocator<char> > const&'], visibility='protected')
    ## callback.h (module 'core'): static std::string ns3::CallbackImplBase::GetCppTypeid() [member function]
    cls.add_method('GetCppTypeid', 
                   'std::string', 
                   [], 
...
def register_Ns3Channel_methods(root_module, cls):
    ...
    cls.add_constructor([])
    ## channel.h (module 'network'): ns3::Ptr<ns3::NetDevice> ns3::Channel::GetDevice(size_t i) const [member function]
    ...
    cls.add_method('GetId', 
                   ...
                   [], 
                   is_const=True)
    ## channel.h (module 'network'): size_t ns3::Channel::GetNDevices() const [member function]
...
def register_Ns3NetDeviceQueueInterface_methods(root_module, cls):
    ...
    cls.add_constructor([])
    ## net-device-queue-interface.h (module 'network'): size_t ns3::NetDeviceQueueInterface::GetNTxQueues() const [member function]
    ...
    cls.add_method('GetSelectQueueCallback', 
                   ...
                   [], 
                   is_const=True)
    ## net-device-queue-interface.h (module 'network'): ns3::Ptr<ns3::NetDeviceQueue> ns3::NetDeviceQueueInterface::GetTxQueue(size_t i) const [member function]
    ...
    cls.add_method('GetTypeId', 
                   ...
                   [], 
                   is_static=True)
    ## net-device-queue-interface.h (module 'network'): void ns3::NetDeviceQueueInterface::SetNTxQueues(size_t numTxQueues) [member function]
    cls.add_method('SetNTxQueues', 
                   'void', 
                   [param('size_t', 'numTxQueues')])
...
def register_Ns3SimpleChannel_methods(root_module, cls):
    ...
    cls.add_method('BlackList', 
                   ...
                   is_virtual=True)
    ## simple-channel.h (module 'network'): ns3::Ptr<ns3::NetDevice> ns3::SimpleChannel::GetDevice(size_t i) const [member function]
    cls.add_method('GetDevice', 
                   'ns3::Ptr< ns3::NetDevice >', 
                   [param('size_t', 'i')], 
                   is_const=True, is_virtual=True)
    ## simple-channel.h (module 'network'): size_t ns3::SimpleChannel::GetNDevices() const [member function]
    cls.add_method('GetNDevices', 
                   'size_t', 
                   [], 
                   is_const=True, is_virtual=True)
...
def register_Ns3ErrorChannel_methods(root_module, cls):
    ...
    cls.add_method('Add', 
                   ...
                   [param('ns3::Ptr< ns3::SimpleNetDevice >', 'device')], 
                   is_virtual=True)
    ## error-channel.h (module 'network'): ns3::Ptr<ns3::NetDevice> ns3::ErrorChannel::GetDevice(size_t i) const [member function]
    cls.add_method('GetDevice', 
                   'ns3::Ptr< ns3::NetDevice >', 
                   [param('size_t', 'i')], 
                   is_const=True, is_virtual=True)
    ## error-channel.h (module 'network'): size_t ns3::ErrorChannel::GetNDevices() const [member function]
    cls.add_method('GetNDevices', 
                   'size_t', 
                   [], 
                   is_const=True, is_virtual=True)
