...
LoRaWANErrorDistanceTestCase::DoRun (void)
{
  ...
  params.m_loraWANChannelIndex = 0; //cant have channel index 0 like this apparently 
  ...
  NS_TEST_ASSERT_MSG_EQ (GetReceived (), 1000, "Error Model exists or something else");
  ...
  : TestSuite ("lorawan-error-model", UNIT)
{
  ...
  //LogComponentEnable("LoRaWANNetDevice",LOG_LEVEL_WARN);
