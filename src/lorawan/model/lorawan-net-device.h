...
public:
  ...
  virtual void SetNetID (uint32_t NetID,int nettype);
  virtual uint32_t GetNetID (void) const; 
  virtual int GetNettype (void) const; 
...
private:
  ...
  /**
   * NetID is the networks ID assigned by LoRa alliance 
   * Nettype is netID type
   * 
   */
