...
def register_types(module):
    ...
    ## traced-value.h (module 'core'): ns3::TracedValue<long long> [class]
    module.add_class('TracedValue', import_from_module='ns.core', template_parameters=['long long'])
    ...
    ## callback.h (module 'core'): ns3::CallbackImpl<void, long long, long long, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> [class]
    module.add_class('CallbackImpl', import_from_module='ns.core', parent=root_module['ns3::CallbackImplBase'], template_parameters=['void', 'long long', 'long long', 'ns3::empty', 'ns3::empty', 'ns3::empty', 'ns3::empty', 'ns3::empty', 'ns3::empty', 'ns3::empty'])
    ...
    module.add_container('std::map< std::string, unsigned int >', ('std::basic_string< char, std::char_traits< char >, std::allocator< char > >', 'unsigned int'), container_type='map')
    module.add_container('std::map< std::string, unsigned long long >', ('std::basic_string< char, std::char_traits< char >, std::allocator< char > >', 'long long unsigned int'), container_type='map')
...
def register_types_ns3_Hash(module):
    ...
    typehandlers.add_type_alias('uint32_t ( * ) ( char const *, size_t const )', 'ns3::Hash::Hash32Function_ptr')
    typehandlers.add_type_alias('uint32_t ( * ) ( char const *, size_t const )*', 'ns3::Hash::Hash32Function_ptr*')
    typehandlers.add_type_alias('uint32_t ( * ) ( char const *, size_t const )&', 'ns3::Hash::Hash32Function_ptr&')
    typehandlers.add_type_alias('uint64_t ( * ) ( char const *, size_t const )', 'ns3::Hash::Hash64Function_ptr')
    typehandlers.add_type_alias('uint64_t ( * ) ( char const *, size_t const )*', 'ns3::Hash::Hash64Function_ptr*')
    typehandlers.add_type_alias('uint64_t ( * ) ( char const *, size_t const )&', 'ns3::Hash::Hash64Function_ptr&')
...
def register_methods(root_module):
    ...
    register_Ns3TracedValue__Long_long_methods(root_module, root_module['ns3::TracedValue< long long >'])
    ...
    register_Ns3CallbackImpl__Void_Long_long_Long_long_Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_methods(root_module, root_module['ns3::CallbackImpl< void, long long, long long, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >'])
...
def register_Ns3QueueDiscContainer_methods(root_module, cls):
    ...
    cls.add_method('End', 
                   ...
                   [], 
                   is_const=True)
    ## queue-disc-container.h (module 'traffic-control'): ns3::Ptr<ns3::QueueDisc> ns3::QueueDiscContainer::Get(size_t i) const [member function]
    cls.add_method('Get', 
                   'ns3::Ptr< ns3::QueueDisc >', 
                   [param('size_t', 'i')], 
                   is_const=True)
    ## queue-disc-container.h (module 'traffic-control'): size_t ns3::QueueDiscContainer::GetN() const [member function]
    cls.add_method('GetN', 
                   'size_t', 
                   [], 
                   is_const=True)
...
def register_Ns3TracedValue__Long_long_methods(root_module, cls):
    ## traced-value.h (module 'core'): ns3::TracedValue<long long>::TracedValue() [constructor]
    cls.add_constructor([])
    ## traced-value.h (module 'core'): ns3::TracedValue<long long>::TracedValue(ns3::TracedValue<long long> const & o) [constructor]
    cls.add_constructor([param('ns3::TracedValue< long long > const &', 'o')])
    ## traced-value.h (module 'core'): ns3::TracedValue<long long>::TracedValue(long long int const & v) [constructor]
    cls.add_constructor([param('long long int const &', 'v')])
    ## traced-value.h (module 'core'): void ns3::TracedValue<long long>::Connect(ns3::CallbackBase const & cb, std::string path) [member function]
    cls.add_method('Connect', 
                   'void', 
                   [param('ns3::CallbackBase const &', 'cb'), param('std::string', 'path')])
    ## traced-value.h (module 'core'): void ns3::TracedValue<long long>::ConnectWithoutContext(ns3::CallbackBase const & cb) [member function]
    cls.add_method('ConnectWithoutContext', 
                   'void', 
                   [param('ns3::CallbackBase const &', 'cb')])
    ## traced-value.h (module 'core'): void ns3::TracedValue<long long>::Disconnect(ns3::CallbackBase const & cb, std::string path) [member function]
    cls.add_method('Disconnect', 
                   'void', 
                   [param('ns3::CallbackBase const &', 'cb'), param('std::string', 'path')])
    ## traced-value.h (module 'core'): void ns3::TracedValue<long long>::DisconnectWithoutContext(ns3::CallbackBase const & cb) [member function]
    cls.add_method('DisconnectWithoutContext', 
                   'void', 
                   [param('ns3::CallbackBase const &', 'cb')])
    ## traced-value.h (module 'core'): long long int ns3::TracedValue<long long>::Get() const [member function]
    cls.add_method('Get', 
                   'long long int', 
                   [], 
                   is_const=True)
    ## traced-value.h (module 'core'): void ns3::TracedValue<long long>::Set(long long int const & v) [member function]
    cls.add_method('Set', 
                   'void', 
                   [param('long long int const &', 'v')])
    return
...
def register_Ns3TrafficControlHelper_methods(root_module, cls):
    ...
    cls.add_constructor([])
    ## traffic-control-helper.h (module 'traffic-control'): static ns3::TrafficControlHelper ns3::TrafficControlHelper::Default(size_t nTxQueues=1) [member function]
    cls.add_method('Default', 
                   'ns3::TrafficControlHelper', 
                   [param('size_t', 'nTxQueues', default_value='1')], 
                   is_static=True)
...
def register_Ns3QueueDisc_methods(root_module, cls):
    ...
    cls.add_method('GetCurrentSize', 
                   'ns3::QueueSize', 
                   [])
    ## queue-disc.h (module 'traffic-control'): ns3::Ptr<ns3::Queue<ns3::QueueDiscItem>> ns3::QueueDisc::GetInternalQueue(size_t i) const [member function]
    ...
    cls.add_method('GetNBytes', 
                   ...
                   [], 
                   is_const=True)
    ## queue-disc.h (module 'traffic-control'): size_t ns3::QueueDisc::GetNInternalQueues() const [member function]
    cls.add_method('GetNInternalQueues', 
                   'size_t', 
                   [], 
                   is_const=True)
    ## queue-disc.h (module 'traffic-control'): size_t ns3::QueueDisc::GetNPacketFilters() const [member function]
    ...
    cls.add_method('GetNPackets', 
                   ...
                   [], 
                   is_const=True)
    ## queue-disc.h (module 'traffic-control'): size_t ns3::QueueDisc::GetNQueueDiscClasses() const [member function]
    ...
    cls.add_method('GetNetDeviceQueueInterface', 
                   ...
                   [], 
                   is_const=True)
    ## queue-disc.h (module 'traffic-control'): ns3::Ptr<ns3::PacketFilter> ns3::QueueDisc::GetPacketFilter(size_t i) const [member function]
    cls.add_method('GetPacketFilter', 
                   'ns3::Ptr< ns3::PacketFilter >', 
                   [param('size_t', 'i')], 
                   is_const=True)
    ## queue-disc.h (module 'traffic-control'): ns3::Ptr<ns3::QueueDiscClass> ns3::QueueDisc::GetQueueDiscClass(size_t i) const [member function]
...
def register_Ns3CallbackImplBase_methods(root_module, cls):
    ...
    cls.add_method('GetCppTypeid', 
                   'std::string', 
                   [], 
                   is_static=True, template_parameters=['long long'], visibility='protected')
    ## callback.h (module 'core'): static std::string ns3::CallbackImplBase::GetCppTypeid() [member function]
    cls.add_method('GetCppTypeid', 
                   'std::string', 
                   [], 
...
def register_Ns3DeterministicRandomVariable_methods(root_module, cls):
    ...
    cls.add_constructor([])
    ## random-variable-stream.h (module 'core'): void ns3::DeterministicRandomVariable::SetValueArray(double * values, size_t length) [member function]
    cls.add_method('SetValueArray', 
                   'void', 
                   [param('double *', 'values'), param('size_t', 'length')])
...
def register_Ns3CallbackImpl__Void_Long_long_Long_long_Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_methods(root_module, cls):
    ## callback.h (module 'core'): ns3::CallbackImpl<void, long long, long long, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty>::CallbackImpl() [constructor]
    cls.add_constructor([])
    ## callback.h (module 'core'): ns3::CallbackImpl<void, long long, long long, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty>::CallbackImpl(ns3::CallbackImpl<void, long long, long long, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> const & arg0) [constructor]
    cls.add_constructor([param('ns3::CallbackImpl< void, long long, long long, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty > const &', 'arg0')])
    ## callback.h (module 'core'): static std::string ns3::CallbackImpl<void, long long, long long, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty>::DoGetTypeid() [member function]
    cls.add_method('DoGetTypeid', 
                   'std::string', 
                   [], 
                   is_static=True)
    ## callback.h (module 'core'): std::string ns3::CallbackImpl<void, long long, long long, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty>::GetTypeid() const [member function]
    cls.add_method('GetTypeid', 
                   'std::string', 
                   [], 
                   is_const=True, is_virtual=True)
    ## callback.h (module 'core'): void ns3::CallbackImpl<void, long long, long long, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty>::operator()(long long int arg0, long long int arg1) [member operator]
    cls.add_method('operator()', 
                   'void', 
                   [param('long long int', 'arg0'), param('long long int', 'arg1')], 
                   custom_name='__call__', is_virtual=True, is_pure_virtual=True)
    return
